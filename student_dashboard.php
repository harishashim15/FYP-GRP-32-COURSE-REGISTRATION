    ...
    <div class="row g-4">
        ...
        <div class="col-md-3">
            <div class="dashboard-card">
                ...
                <p>Waiting for advisor review</p>
            </div>
        </div>
        <div class="col-md-3">
            <div class="dashboard-card">
        ...
        <a href="student_courses.php" class="action-btn">
            <div class="action-left">
                ...
                <div>
                    ...
                    <small>View and register for available courses</small>
                </div>
            </div>
            <i class="bi bi-chevron-right"></i>
        </a>
        <a href="student_registration.php" class="action-btn">
            <div class="action-left">
                <div class="action-icon">
                    <i class="bi bi-file-earmark-text"></i>
                </div>
                <div>
                    <h5 class="mb-0">My Registration</h5>
                    <small>Check your registration status</small>
                </div>
            </div>
            <i class="bi bi-chevron-right"></i>
        </a>
