...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .back-btn { background: #6c757d; color: white; padding: 8px 20px; border-radius: 25px; text-decoration: none; display: inline-flex; align-items: center; gap: 5px; }
        @media (max-width: 992px) { .sidebar { transform: translateX(-280px); } .main-content { margin-left: 0; } }
    </style>
</head>
<body>
<div class="sidebar">
...
<div class="main-content">
    ...
    <div class="page-header">
        ...
        <a href="manage_students.php" class="back-btn"><i class="bi bi-arrow-left"></i> Back to Students</a>
    </div>
                ...
                <?php if ($registrations->num_rows > 0): ?>
                    <?php while ($reg = $registrations->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><span class="badge bg-<?php echo $reg['status'] == 'approved' ? 'success' : ($reg['status'] == 'rejected' ? 'danger' : 'warning'); ?>"><?php echo ucfirst($reg['status']); ?></span></td>
                           <a href="admin_view_registration_slip.php?id=<?php echo $reg['id']; ?>&student_id=<?php echo $student_id; ?>" class="btn-view"><i class="bi bi-eye"></i> View Slip</a>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
